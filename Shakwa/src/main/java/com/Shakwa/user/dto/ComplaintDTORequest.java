...
@Schema(description = "Complaint Request", example = """
{
  ...
  "citizenId": 1,
  "attachments": ["/uploads/file1.png", "/uploads/file2.pdf"]
}
""")
public class ComplaintDTORequest {
    ...
    @Schema(description = "List of attachment file paths (png or pdf)", example = "[\"/uploads/file1.png\", \"/uploads/file2.pdf\"]")
    @Builder.Default
